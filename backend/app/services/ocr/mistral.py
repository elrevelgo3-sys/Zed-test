"""
Mistral Pixtral OCR Provider - Simplified.
One example instead of 9 rules.
"""
...
# Simple prompt with example - let the model do what it knows
...
class MistralOCR:
    """Mistral Pixtral OCR - simple and effective."""
    ...
    def _parse(self, content: str) -> dict:
        ...
        # Remove markdown if model added it anyway
